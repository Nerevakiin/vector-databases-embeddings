...
// Query Supabase and return a semantically matching text chunk (db already exists)
...
async function getChatCompletion(text, query) {
    ...
    // Push the messages to the array and create a context memory
    chatMessages.push(choices[0].message)
    // print the response on the ui
